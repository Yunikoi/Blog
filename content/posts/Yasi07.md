...
> caffeinated adj. 含咖啡因的 | decaffeinated / decaf adj. 脱咖啡因的 | caffeine intake 咖啡因摄入量 | cut down on caffeine 减少咖啡因摄入

> ##### 同义替换（附雅思释义）
>
> - stimulant：n. 兴奋剂；刺激物（咖啡因属 mild stimulant）
> - coffee / tea consumption：咖啡 / 茶摄入（语境替换）

#### cut off from distraction：隔绝干扰；远离分心因素

> be cut off from distractions 与干扰因素隔绝 | cut off from the outside world 与外界隔绝 | distraction-free environment 无干扰环境

> ##### 同义替换（附雅思释义）
>
> - isolate from distractions：与干扰隔离
> - free from interruption：不受打扰
> - in a controlled setting：在受控环境中（实验语境）

#### nap：小睡；午睡；打盹

> take / have a nap 小睡一会儿 | power nap 短时高效午睡 | nap time 午睡时间 | catnap n. 打盹（口语）

> ##### 同义替换（附雅思释义）
>
> - snooze：v./n. 小睡；打盹
> - doze off：v. 打瞌睡
> - siesta：n. 午睡（尤指热带国家午后小憩）

#### makeup：补偿；补回（sleep makeup 补眠）| 构成；化妆；补考

> sleep makeup / make up for lost sleep 补回失去的睡眠 | make up for 弥补；补偿 | genetic makeup 基因构成 | makeup exam 补考
...
> Tanzanian adj./n. 坦桑尼亚的；坦桑尼亚人 | Dar es Salaam 达累斯萨拉姆（最大城市）| Mount Kilimanjaro 乞力马扎罗山

#### Bolivia：玻利维亚（南美国家）

> Bolivian adj./n. 玻利维亚的；玻利维亚人 | La Paz 拉巴斯（行政首都）| Andes 安第斯山脉（地理背景常考）

#### geographic / geographical：地理的；地理学上的

> geographic location / distribution 地理位置 / 分布 | geographic variation 地域差异 | geographically adv. 在地理上 | geography n. 地理；地形

> ##### 同义替换（附雅思释义）
>
> - regional：adj. 地区的；区域性的
> - spatial：adj. 空间的（地理分布语境可互换）

#### manage to suppress：设法抑制；成功压制

> manage to do 设法 / 成功做到… | suppress v. 抑制；压制；隐瞒 | suppress appetite / emotions / symptoms 抑制食欲 / 情绪 / 症状 | suppression n. 抑制；压制

> ##### 同义替换（附雅思释义）
>
> - succeed in inhibiting：成功抑制（正式）
> - keep … under control：把… 控制住
> - hold back：抑制；阻止

#### circadian：昼夜节律的；约 24 小时周期的

> circadian rhythm / cycle / clock 昼夜节律 / 周期 / 生物钟 | disrupt circadian rhythms 打乱生物钟 | circadian biology 昼夜节律生物学

> ##### 同义替换（附雅思释义）
>
> - biological clock：生物钟
> - daily cycle：日周期
> - 24-hour cycle：24 小时周期

#### respect：方面；着眼点 | 尊重；遵守

> in this respect 在这方面 | with respect to 关于；就… 而言 | in many respects 在许多方面 | pay respect to 向… 致敬 | respect the rules 遵守规则

> ##### 形近易混（附雅思释义）
>
> - aspect：n. 方面
> - regard：n./v.  regard；with regard to 关于
> - respective：adj. 各自的（respective countries 各国）

#### mimic：模仿；模拟；仿效

> mimic natural conditions 模拟自然条件 | mimic the effects of … 模拟… 的效果 | mimicry n. 模仿；拟态 | mimetic adj. 模仿的

> ##### 同义替换（附雅思释义）
>
> - simulate / simulation：v./n. 模拟
> - imitate / imitation：v./n. 模仿
> - replicate：v. 复制；复现（实验语境）

## 0702

#### beyond most of us：超出我们大多数人（的能力 / 范围）

> beyond the reach of most people 超出多数人的能力范围 | beyond what most of us can handle 超出我们大多数人能应付的程度 | beyond one's capacity 超出某人的能力

> ##### 同义替换（附雅思释义）
>
> - out of reach for most people：大多数人够不着
> - too demanding for the average person：对普通人要求过高
> - exceed most people's abilities：超出多数人能力

#### innate：天生的；固有的；与生俱来的

> innate ability / talent 天赋 | innate characteristic 固有特征 | innately adv. 天生地 | innateness n. 先天性

> ##### 同义替换（附雅思释义）
>
> - inborn / inbred：adj. 天生的；遗传的
> - inherent：adj. 固有的；内在的
> - natural：adj. 天生的；自然的

#### tap out / tapping out：耗尽；达到极限；精疲力竭（口语）

> tap out 达到极限；认输；精疲力竭 | cognitive resources tapped out 认知资源耗尽 | tap out a message 敲打出一条信息（字面：按键输入）
...
> simultaneous interpretation 同声传译 | perform tasks simultaneously 同时执行多项任务 | simultaneously adv. 同时地 | simultaneity n. 同时性

> ##### 同义替换（附雅思释义）
>
> - concurrent / concurrently：adj./adv. 同时发生的；并发地
> - at the same time：同时
> - parallel：adj. 并行的；同时进行的

#### ill-advised：不明智的；欠考虑的；不妥当的

> an ill-advised decision / approach 不明智的决定 / 做法 | it would be ill-advised to … … 是不明智的 | ill-advisedly adv.（罕用）

> ##### 同义替换（附雅思释义）
>
> - unwise / inadvisable：adj. 不明智的；不宜的
> - imprudent：adj. 轻率的；欠考虑的
> - misguided：adj. 被误导的；方向错误的

#### approach：方法；途径；处理方式 | 接近；着手处理

> a multitasking approach 多任务处理方式 | take / adopt an approach 采取某种方法 | approach the problem 着手处理问题 | approachable adj. 易接近的；平易近人的

> ##### 衍生拓展短语（附雅思释义）
>
> - approach to：对… 的方法 / 态度
> - new approach：新方法
> - hands-on approach：亲身实践的方法

#### intersection：交叉点；十字路口 | 交集；交汇处

> at the intersection of A and B 在 A 与 B 的交汇处 | the intersection of technology and education 科技与教育的交叉领域 | intersect v. 相交；交叉

> ##### 同义替换（附雅思释义）
>
> - crossroads：n. 十字路口；关键时刻
> - overlap：n./v. 重叠；交集
> - junction：n. 交叉点；连接处

#### impaired：受损的；削弱的；功能下降的

> visually / hearing impaired 视障 / 听障 | impaired performance / function 表现 / 功能下降 | impairment n. 损伤；障碍 | cognitively impaired 认知受损

> ##### 同义替换（附雅思释义）
>
> - diminished：adj. 减弱的；下降的
> - compromised：adj. 受损的；受影响的（compromised ability）
> - deficient：adj. 不足的；有缺陷的

#### switch back and forth：来回切换；交替转换

> switch back and forth between tasks 在任务间来回切换 | switch between A and B 在 A 与 B 之间切换 | switch over 切换过去 | back and forth 来回地

> ##### 同义替换（附雅思释义）
>
> - alternate between：在… 之间交替
> - toggle between：在… 之间切换（技术语境）
> - flip between：快速来回切换

#### juggle：同时应付；兼顾（多项任务 / 责任）；抛接（球）

> juggle work and family 兼顾工作与家庭 | juggle multiple tasks 同时处理多项任务 | juggling n. 兼顾；杂耍 | juggler n. 杂耍演员；善于兼顾者

> ##### 同义替换（附雅思释义）
>
> - balance：v. 平衡；兼顾
> - multitask：v. 多任务处理
> - manage several things at once：同时管理多件事

## 0703

#### ambiguity / ambiguities：模糊；歧义；不明确

> ambiguity n. 模糊；歧义 | ambiguities（复数）多种歧义 / 模糊之处 | ambiguous adj. 模糊的；有歧义的 | ambiguously adv. 含糊地 | lexical ambiguity 词义歧义 | semantic ambiguity 语义歧义 | resolve ambiguity 消除歧义

> ##### 阅读注意（附雅思释义）
>
> - 题干 / 选项用 **ambiguous wording** 时，易在 TRUE/FALSE/NOT GIVEN 中设 **NG**（原文无法唯一对应）
> - **deliberate ambiguity** 故意含糊 → 勿过度推断
> - 与 **vague / unclear** 近义，但 ambiguity 更强调「两种及以上理解都可能」

> ##### 同义替换（附雅思释义）
>
> - vagueness / unclearness：n. 模糊；不清楚
> - equivocation：n. 含糊其辞；模棱两可
> - uncertainty：n. 不确定（语义略宽）
> - unambiguous：adj. 明确的；无歧义的（反义）

> ##### 形近易混（附雅思释义）
>
> - ambiguous：adj. 有歧义的（-ous 形容词）
> - ambivalent：adj. 矛盾的；摇摆不定的（态度两面，≠ 语义歧义）

#### vocal：声音的；发声的 | 直言不讳的 | 声乐部分

> vocal adj. 声音的；用嗓音的 | vocal cords 声带 | vocal communication 口头 / 声音交流 | be vocal about sth. 对… 直言不讳、公开发声 | vocal critic / opponent 大声反对者 | vocals n. 人声；主唱 | vocalist n. 歌手 | vocalize v. 发声；用言语表达 | vocally adv. 用声音地；直言地

> ##### 同义替换（附雅思释义）
>
> - outspoken：adj. 直言的；坦率的（be vocal about ≈ be outspoken on）
> - verbal / oral：adj. 口头的；言语的（vocal 偏「嗓音发出」）
> - articulate：adj./v. 善于表达；清楚说出
> - expressive：adj. 富有表现力的（音乐 / 情感语境）

> ##### 形近易混（附雅思释义）
>
> - vocal：声音的；直言的
> - vocational：adj. 职业的（vocational training 职业培训）
> - vocabulary：n. 词汇（vocab 词库）

#### self-evident：不言而喻的；不证自明的

> self-evident truth / fact 不言而喻的事实 | it is self-evident that … … 是不言而喻的 | self-evidently adv. 不言而喻地

> ##### 同义替换（附雅思释义）
>
> - obvious：adj. 明显的
> - apparent：adj. 显而易见的（较正式）
> - axiomatic：adj. 不证自明的；公理的（学术）
> - manifest：adj. 明显的；清楚的（正式）

> ##### 形近易混（附雅思释义）
>
> - self-evident：无需证明即显然
> - evident：adj. 明显的（evidence n. 证据）
> - self-esteem：n. 自尊（≠ self-evident）

#### vehicle：车辆 | 媒介；载体（抽象，阅读高频）

> motor vehicle 机动车 | electric vehicle (EV) 电动汽车 | a vehicle for change / ideas / expression … 的媒介 / 载体 | language as a vehicle for thought 语言作为思想的载体 | investment vehicle 投资工具

> ##### 阅读注意（附雅思释义）
>
> - 抽象义 **a vehicle for …** = 实现 / 传达… 的手段，≠ 仅「汽车」
> - 题干写 vehicle 而原文 **means / medium / channel** → 同义替换

> ##### 同义替换（附雅思释义）
>
> - medium / means：n. 媒介；手段
> - channel：n. 渠道；途径
> - carrier：n. 载体（carrier of disease 病原体载体）
> - tool / instrument：n. 工具（实现目的）

> ##### 形近易混（附雅思释义）
>
> - vehicle：车辆；载体
> - vessels：n. 船只；容器；血管（blood vessels）

#### interpersonal：人际的；人与人之间的

> interpersonal skills / relationships / communication 人际技能 / 关系 / 沟通 | interpersonal conflict 人际冲突 | interpersonally adv. 人际层面上

> ##### 同义替换（附雅思释义）
>
> - social：adj. 社会的；社交的（social interaction）
> - between individuals：人与人之间的（释义替换）

#### numerical：数字的；数值的

> numerical data / value / analysis 数值数据 / 数值 / 数值分析 | numerically adv. 在数字上 | numeracy n. 计算能力 | numerical superiority 数量优势

> ##### 同义替换（附雅思释义）
>
> - quantitative：adj. 定量的（quantitative research）
> - statistical：adj. 统计的
> - digital：adj. 数字的（数字系统；≠ 数值义时用 digital data）
...
#### in contrast to：与…… 形成对比（不同于 unlike / whereas）

> **A in contrast to B**：A 与 B 相对照（突出差异）| by contrast 相比之下 | contrast with / between 与… 对比

> ##### 阅读注意（附雅思释义）
>
> - 常引出 **对照组**，判断题易考「对比对象是否被调换」→ FALSE
> - 与 **compared with / unlike / whereas** 同属对比信号

> ##### 同义替换（附雅思释义）
>
> - unlike：prep. 与… 不同
> - whereas：conj. … 而…（前后对照）
> - as opposed to：与… 相反；而非
> - on the other hand：另一方面

#### exactness：精确；准确；一丝不苟

> with exactness 精确地 | mathematical exactness 数学意义上的精确 | exact adj. 精确的 | exactly adv. 精确地 | exactitude n. 精确（正式）

> ##### 同义替换（附雅思释义）
>
> - precision / accuracy：n. 精确；准确
> - meticulousness：n. 一丝不苟
> - rigour / rigor：n. 严谨

#### mystique：神秘感；传奇色彩；神秘魅力

> the mystique of … … 的神秘魅力 | shrouded in mystique 笼罩着神秘色彩 | mysterious adj. 神秘的 | mystify v. 使困惑

> ##### 同义替换（附雅思释义）
>
> - aura of mystery：神秘氛围
> - allure / fascination：n. 吸引力；魅力
> - enigma：n. 谜；神秘之物

#### ill-chosen：选得不恰当的；不合适的

> an ill-chosen word / example / moment 不恰当的措辞 / 例子 / 时机 | ill-advised 不明智的（近义）| well-chosen 精心挑选的（反义）

> ##### 同义替换（附雅思释义）
>
> - inappropriate / unsuitable：adj. 不合适的
> - unfortunate：adj. 不幸的；欠妥的（an unfortunate remark）
> - infelicitous：adj. 不恰当的（正式）

#### absurd：荒谬的；可笑的 | 荒诞

> absurd idea / conclusion / situation 荒谬的想法 / 结论 / 情况 | the absurd n. 荒诞（哲学）| absurdity n. 荒谬 | absurdly adv. 荒谬地

> ##### 同义替换（附雅思释义）
>
> - ridiculous / ludicrous：adj. 可笑的；荒谬的
> - preposterous：adj. 荒谬绝伦的（正式）
> - nonsensical：adj. 毫无道理的

#### faithful：忠实的；忠诚的 | 如实的；忠于原作的

> faithful friend / servant 忠实的朋友 / 仆人 | faithful reproduction / translation 如实再现 / 忠实翻译 | faithfully adv. 忠实地 | faithfulness n. 忠诚；忠实度 | faith n. 信念；信任

> ##### 同义替换（附雅思释义）
>
> - loyal / devoted：adj. 忠诚的
> - accurate / true to the original：忠于原文 / 原貌
> - reliable：adj. 可靠的（忠实于事实）
...
#### nonetheless / nevertheless：尽管如此；然而（强转折）

> **Nonetheless, …** / **Nevertheless, …** 尽管如此，…（后文常引出重点或反转）| 可换用 however，但语气更正式、转折更强

> ##### 阅读注意（附雅思释义）
>
> - 让步后 **真正观点** 往往在 nonetheless 之后 → 判断题勿只看前半句
> - 与 **however / yet / still** 同类信号

> ##### 同义替换（附雅思释义）
>
> - however / yet / still：然而；仍然
> - in spite of this：尽管如此
> - even so：即便如此

#### forces：力量；势力 | 军队 | 迫使（force 动词）

> natural / economic / social forces 自然 / 经济 / 社会力量 | market forces 市场力量 | armed forces 武装部队 | force sb. to do 迫使 | force n. 力（physics）

> ##### 阅读注意（附雅思释义）
>
> - **forces** 复数常指「各种力量 / 因素」，≠ 仅「武力」
> - **driving force** 驱动力；**task force** 特别工作组

> ##### 同义替换（附雅思释义）
>
> - power / strength：n. 力量
> - troops / military：n. 军队
> - compel / oblige：v. 迫使（force v.）

#### nature：自然；本性 | 性质；种类

> human nature 人性 | by nature 天生地 | in nature 在自然界中 | the nature of sth. … 的本质 / 性质 | forces of nature 自然力量 | second nature 第二天性（习惯成自然）

> ##### 阅读注意（附雅思释义）
>
> - **the nature of the problem** = 问题的性质（≠ 仅「自然」）
> - **in the nature of things** 理所当然地；事物本质如此

> ##### 同义替换（附雅思释义）
>
> - character / essence：n. 本质；特性
> - natural world：自然界（nature 指环境时）
> - kind / sort：n. 种类（things of that nature）
